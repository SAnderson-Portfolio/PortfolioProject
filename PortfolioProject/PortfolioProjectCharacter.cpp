...
#include "PortfolioProjectProjectile.h"
	...
	if (ProjectileClass != nullptr)
	{
		...
		if (World != nullptr)
		{
			...
			else
			{
				...
				World->SpawnActor<APortfolioProjectProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
			}
		}
	}
...
void APortfolioProjectCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void APortfolioProjectCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
//void APortfolioProjectCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
...
bool APortfolioProjectCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	if (FPlatformMisc::SupportsTouchInput() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &APortfolioProjectCharacter::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &APortfolioProjectCharacter::EndTouch);

		//Commenting this out to be more consistent with FPS BP template.
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &APortfolioProjectCharacter::TouchUpdate);
		return true;
	}
